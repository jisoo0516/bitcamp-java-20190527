...
public class Controller01_1 {
  ...
  @GetMapping("h1") 
  //@ResponseBody // 뷰 이름을 리턴할 때는 이 애노테이션을 붙이면 안된다.
  public String handler1(Model model) {
    ...
    // 웹 애플리케이션 경로가 /bitcamp-java-spring-webmvc라면, JSP 경로는 다음과 같아.
  ...
  public String handler3(Map<String,Object> map) {
    ...
    // 1) http://localhost:8888/bitcamp-java-spring-webmvc/java-spring-webmvc/jsp/c01_1.jsp
    //    => 클라이언트가 요청할 수 있다.
    // 2) http://localhost:8888/bitcamp-java-spring-webmvc/java-spring-webmvc/WEB-INF/jsp/c01_1.jsp
    //    => 클라이언트가 요청할 수 없다.
