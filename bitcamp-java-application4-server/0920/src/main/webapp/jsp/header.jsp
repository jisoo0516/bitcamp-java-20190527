...
<nav id='header' class='navbar navbar-expand-lg navbar-light bg-light'>
  <a class='navbar-brand' href='#'> <img src='/images/yo.png'
    height='35' class='d-inline-block align-top'>수업관리시스템
  </a>
  ...
  <div class='collapse navbar-collapse' id='navbarSupportedContent'>
    <ul class='navbar-nav'>
      ...
      <li class='nav-item active'><a class='nav-link'
        href='/lesson/list'>수업관리</a></li>
      <li class='nav-item active'><a class='nav-link'
        href='/member/list'>회원관리</a></li>
      <li class='nav-item active'><a class='nav-link'
        href='/photoboard/list'>사진게시판</a></li>
    </ul>
  </div>
