  ...
  public App() throws Exception {
    ...
    try {
      ...
      commandMap.put("/photoboard/add", 
          new PhotoBoardAddCommand(photoBoardDao, photoFileDao, conFactory));
      commandMap.put("/photoboard/delete", 
          new PhotoBoardDeleteCommand(photoBoardDao, photoFileDao, conFactory));
      ...
      commandMap.put("/photoboard/update", 
          new PhotoBoardUpdateCommand(photoBoardDao, photoFileDao, conFactory));
