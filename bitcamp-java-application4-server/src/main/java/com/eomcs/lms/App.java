// v59_2: WebApplicaiontIntializer를 사용하여 DispatcherServlet 배치하기
package com.eomcs.lms;

// 작업:
// => com.eomcs.lms.controller를 com.eomcs.lms.web으로 패키지명 변경
// => com.eomcs.lms.config.WebConfig 설정
...
//    - AppWebApplicationInitializer에서 이 Java Config 클래스를 직접 지정하기 때문이다.
