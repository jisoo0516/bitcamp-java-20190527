...
public class App {
  ...
  public void addAPplicaiontContextListener(ApplicationContextListener listener) {
  ...
  public static void main(String[] args) {
    ...
    app.addAPplicaiontContextListener(new HelloApplicationContextListener());
    app.addAPplicaiontContextListener(new DataLoaderListener());
